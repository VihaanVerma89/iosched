...
public class ScheduleDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.BLOCKS + " ("
                ...
                + ScheduleContract.BlocksColumns.BLOCK_META + " TEXT,"
        ...
        db.execSQL("CREATE TABLE " + Tables.TRACKS + " ("
                ...
                + ScheduleContract.TracksColumns.TRACK_LEVEL + " INTEGER,"
                + ScheduleContract.TracksColumns.TRACK_ORDER_IN_LEVEL + " INTEGER,"
                + ScheduleContract.TracksColumns.TRACK_META + " INTEGER NOT NULL DEFAULT 0,"
                + ScheduleContract.TracksColumns.TRACK_ABSTRACT + " TEXT,"
                + ScheduleContract.TracksColumns.TRACK_HASHTAG + " TEXT,"
        ...
        db.execSQL("CREATE TABLE " + Tables.SESSIONS + " ("
                ...
                + ScheduleContract.SessionsColumns.SESSION_TYPE + " TEXT,"
                ...
                + ScheduleContract.SessionsColumns.SESSION_HASHTAGS + " TEXT,"
                ...
                + ScheduleContract.SessionsColumns.SESSION_LIVESTREAM_URL + " TEXT,"
    ...
    private void doMigration2013RM2(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.FEEDBACK + " ("
                ...
                + ScheduleContract.FeedbackColumns.ANSWER_WILLUSE + " INTEGER NOT NULL,"
        ...
        db.execSQL("CREATE TABLE " + Tables.MAPMARKERS + " ("
                + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + ScheduleContract.MapMarkerColumns.MARKER_ID+ " TEXT NOT NULL,"
                + ScheduleContract.MapMarkerColumns.MARKER_TYPE+ " TEXT NOT NULL,"
                + ScheduleContract.MapMarkerColumns.MARKER_LATITUDE+ " DOUBLE NOT NULL,"
                + ScheduleContract.MapMarkerColumns.MARKER_LONGITUDE+ " DOUBLE NOT NULL,"
                + ScheduleContract.MapMarkerColumns.MARKER_LABEL+ " TEXT,"
                + ScheduleContract.MapMarkerColumns.MARKER_FLOOR+ " INTEGER NOT NULL,"
                + ScheduleContract.MapMarkerColumns.MARKER_TRACK+ " TEXT,"
                + "UNIQUE (" + ScheduleContract.MapMarkerColumns.MARKER_ID + ") ON CONFLICT REPLACE)");
    }
