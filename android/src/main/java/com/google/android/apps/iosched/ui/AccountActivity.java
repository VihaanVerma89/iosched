...
public class AccountActivity extends ActionBarActivity
    ...
    public static class SignInSetupFragment extends ListFragment
    {
        ...
        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_login_setup, container, false);
            final TextView descriptionView  = (TextView)rootView.findViewById(R.id.login_setup_desc);

            descriptionView.setText(Html.fromHtml(getString(mDescriptionHeaderResId)) + getString(mDescriptionBodyResId));
        return rootView;
        }
        ...
        public void onResume() {
            super.onResume();
            setListAdapter(new ArrayAdapter<String>(getActivity(), R.layout.list_item_login_option, getResources().getStringArray(mSelectionResId)));
        }
                ...
                if (position == 0) {
                    ...
                    if (WiFiUtils.shouldBypassWiFiSetup(activity)) {
                        ...
                        getFragmentManager().beginTransaction()
                                .replace(R.id.root_container, SignInSetupFragment.makeFragment(SETUP_WIFI), "setup_wifi")
    ...
    {
        private static final int TRY_AGAIN_DELAY_MILLIS = 7 * 1000;
